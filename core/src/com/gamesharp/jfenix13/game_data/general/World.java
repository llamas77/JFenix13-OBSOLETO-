...
public class World extends Actor {
    ...
    public void setTecho() {
        MapTile tile = mapa.getTile((int)pos.getX(), (int)pos.getY());
        this.techo = tile.getTrigger() == 1 || tile.getTrigger() == 2 || tile.getTrigger() == 4;
    }


    public void setMouseTile(Position pos) {
        mouseTile.setX(this.pos.getX() + pos.getX() / TILE_PIXEL_WIDTH - WINDOWS_TILE_WIDTH / 2);
        mouseTile.setY(this.pos.getY() + (getHeight() - pos.getY()) / TILE_PIXEL_HEIGHT - WINDOWS_TILE_HEIGHT / 2);
    }
}
